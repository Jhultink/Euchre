...
/**
 * This class holds the result of a deal, which is returned by the GameDeck.Deal() method
...
public class Deal {
	...
	/**
	 * @param blackOne the blackOne to set
	 */
	...
	/**
	 * @param blackTwo the blackTwo to set
	 */
